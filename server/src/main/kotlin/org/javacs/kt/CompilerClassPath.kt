...
class CompilerClassPath(
    ...
    private fun isBuildScript(file: Path): Boolean = file.fileName.toString().let { it == "pom.xml" || it == "build.gradle" || it == "build.gradle.kts" || it == "BUILD.bazel" || it == "WORKSPACE.bazel" || it == "WORKSPACE" }
